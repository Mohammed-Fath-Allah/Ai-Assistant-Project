...
export default function ChatPage() {
  ...
  const mockAssistants = [
    { id: "1", name: "Translation Bot", avatar: "🤖", systemPrompt: "You only answer about those 3 question hey question and how u doing question and cooding and programation questions."  }
  ];
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer 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`,
